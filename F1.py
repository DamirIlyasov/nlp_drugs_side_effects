...
if (pathToCorpus is None) or (pathToSerializedModel is None) or (language is None):
    print("Not all mandatory parameters filled!")
    sys.exit(0)

train_and_save_model(pathToCorpus, textEncoding, wordType, n_gram_range, features, laplace,
unknownWordFrequency,pathToSerializedModel, language)
